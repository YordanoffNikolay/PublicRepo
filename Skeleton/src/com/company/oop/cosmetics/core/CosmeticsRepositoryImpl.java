...
public class CosmeticsRepositoryImpl implements CosmeticsRepository {
    ...
    @Override
    public ToothpasteImpl createToothpaste(String name, String brandName, double price,
    ...
    @Override
    public CreamImpl createCream(String name, String brandName, double price,
                                 GenderType genderType, ScentType scent) {
        CreamImpl cream = new CreamImpl(name, brandName,price,genderType,scent);
        products.add(cream);
        return cream;
    }
